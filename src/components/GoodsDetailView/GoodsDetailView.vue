	...
	<div class="goods-detail-view" v-if="goodsDetail">
		...
		<div class="content-view">
			...
			<div class="price-view">
				...
				<span class="sale-item" v-show="goodsDetail.sale">特價</span>
			</div>
			...
			<div class="standard-view">
				...
				<div class="side">
					...
					<select name="degree">
						<option v-for="item,index in goodsDetail.degree" :key="index" :value="item">{{ item }}</option>
					</select>
				</div>
		...
		<div class="appraise-view">
			...
			<div class="appraise-content">
				<div class="box" ref="scrollView">
					<UserAppraiseView ref="userAppraise" v-for="item,index in goodsDetail.appraise.list" :key="index"
						:appraise='item'></UserAppraiseView>
				</div>
			</div>
		</div>
		...
		<van-goods-action>
			...
			<van-goods-action-button color="black" type="warning" text="加入購物車" @click="onAddCart"/>
			<van-goods-action-button color="red" type="danger" text="立即購買" @click="onBuy" />
		</van-goods-action>
	</div>
</template>
